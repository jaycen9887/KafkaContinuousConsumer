...
public class KafkaConsumerConfig {
	...
	@Bean
	public ConsumerFactory<String, Menu> consumerFactory() throws IOException {
		return new DefaultKafkaConsumerFactory<>(consumerConfigs(), new StringDeserializer(),
				new JsonDeserializer<>(Menu.class));
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, Menu> kafkaListenerContainerFactory() throws IOException {
